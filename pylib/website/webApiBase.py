...
class WEB_API:
    ...
    def __init__(self):
        ...
        self.ws.headers = {
                                        ...
                                        "appType": "0",
                                        "uid": "",
                                        "sign": "{}".format(sign.build_sign(self.timestemp)),
    ...
    def Get_Token(self,deviceId = "123",osType = "WEB",username = 'qwe220805',password = 'abc123456',code = None):
        ...
        try:
            ...
            self.ws.headers.update({"token":str(response.json()['data']['token'])})
        except:
            print("登錄失敗")
