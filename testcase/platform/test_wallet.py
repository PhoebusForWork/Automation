...
class Test_UserTransfer():
    ...
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_user_wallets'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_user_trade_info'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_user_fund'))
    ...
    @allure.story("轉帳紀錄")
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_game_transfer'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'update_balance_all'))
    ...
    @allure.story("後台一鍵收回")
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'user_withdraw_all'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'user_deposit'))
...
class Test_GameTransferFail():
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_fail_approver'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'get_game_transfer_fail_list'))
    ...
    @allure.title("{test[scenario]}")
    @pytest.mark.parametrize("test", td.get_test_case(testData, 'trade_manual_result'))
