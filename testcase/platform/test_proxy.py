...
class TestProxyChannel:
    ...
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_delete_channel'))
    def test_proxy_delete_channel(test, get_platform_token):
        ...
        if '存在id' in test['req_url']:
            ...
            test['req_url'] = test['req_url'].replace(
                "存在id",
                str(
                    channel_id.get_available_channel_auto(
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_get_channel_all'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_available_channel'))
...
class TestProxyGroup:
    ...
    def test_proxy_add_group(test, get_platform_token):
        ...
        if json_replace['groupName'] == "不重複名稱":
            json_replace['groupName'] = json_replace['groupName'] + \
                str(random.randrange(99999))
    ...
    def test_proxy_delete_group(test, get_platform_token):
        if "存在groupId" in test['req_url']:
            ...
            test['req_url'] = test['req_url'].replace(
                "存在groupId",
                str(groupId.get_exist_group_auto(
                    plat_token=get_platform_token)))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_get_groupsAndChannels'))
...
class TestProxyCommission:
    ...
    @pytest.mark.parametrize(
        "test",
        test_data.get_case('proxy_get_commission_template_subCommissionConfig')
    )
    def test_proxy_get_commission_template_subCommissionConfig(
    ...
    @pytest.mark.parametrize(
        "test",
        test_data.get_case(
            'proxy_edit_commission_template_subCommissionConfig'))
    def test_proxy_edit_commission_template_subCommissionConfig(
            test, get_platform_token):
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_commission_template'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_commission_list'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_get_commission'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_edit_commission'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_get_settlementShares'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_edit_platformFeeShares')
                             )
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_get_commissionConfig'))
    ...
    @pytest.mark.regression
    @pytest.mark.parametrize("test",
                             test_data.get_case('proxy_edit_commissionConfig'))
...
def test_proxy_add_proxy(test, get_platform_token):
    ...
    if json_replace['proxyAccount'] == "不重複名稱":
        json_replace['proxyAccount'] = 'proxyAccount' + \
            str(random.randrange(99999))
...
@pytest.mark.regression
@pytest.mark.parametrize("test",
                         test_data.get_case('proxy_get_commission_avg'))
...
@pytest.mark.regression
@pytest.mark.parametrize("test",
                         test_data.get_case('proxy_get_manage_approver_list'))
...
@pytest.mark.regression
@pytest.mark.parametrize("test",
                         test_data.get_case('proxy_manage_approver_first'))
def test_proxy_manage_approver_first(test, get_platform_token):
    ...
    if "二審完成訂單" in test['req_url']:
        ...
        test['req_url'] = test['req_url'].replace(
            "二審完成訂單",
            orderid.get_second_approval_success_id(token=get_platform_token))
...
@pytest.mark.regression
@pytest.mark.parametrize("test",
                         test_data.get_case('proxy_manage_approver_second'))
